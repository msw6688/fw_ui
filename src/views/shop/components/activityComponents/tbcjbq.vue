<template>
  <div class="form">
    ...
    <div class="form-item">
      <span class="form-required">*必填</span>
      <span class="form-label">打标二维码：</span>
      <el-upload
        class="avatar-uploader"
        action
        ...
        :show-file-list="false"
      >
        <img v-if="form.taskGoodsList[0].codeImg" :src="form.taskGoodsList[0].codeImg" class="avatar">
        <i v-else class="el-icon-plus avatar-uploader-icon"/>
      </el-upload>
      <div style="margin-top: 60px">
        <el-button class="btn-theme" size="mini">生成二维码</el-button>
      </div>
    </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            uploadImageDbewm(e) {
                this.form.taskGoodsList[0].codeImg = uploadImage(e)
            },
