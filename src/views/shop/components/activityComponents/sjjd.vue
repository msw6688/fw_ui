  ...
  <div class="form">
    ...
    <div class="form-item">
      ...
      <div class="form-block radio-list">
        <el-radio-group class="item" style="margin-left: 14px;padding-top: 10px;"
    ...
    <div class="form-item" v-for="item in addtkl" v-if="form.searchType===2">
      ...
      <span style="color: #97A8BE;width: 50px;text-align: center">添加</span>
      <el-input v-model="order2[item-1]" size="small" style="width: 140px">
    ...
    <div class="form-item" style="position: relative" v-for="item in addewm" v-if="form.searchType===3">
      ...
      <span style="color: #97A8BE;width: 50px;text-align: center">添加</span>
      <el-input v-model="order3[item-1]" size="small" style="width: 140px">
        <template slot="append">单</template>
      </el-input>
    </div>
    ...
    <div class="form-item" v-for="imgItem in imgList">
      <span class="form-required"></span>
      <span class="form-label">{{ imgItem.name }}：</span>
      <el-checkbox-group style="display: flex;" v-model="form.screenshotDetailIds">
        <div class="checkbox-mr" style="width: 135px"
          ...
          <el-checkbox :label="childImgItem.id">
            ...
            <div class="checkbox-button-width"
                 style="border: 1px solid #DCDFE6;padding: 5px 7px;width: 105px;height:28px;text-align: center">
              {{ childImgItem.name}}
            </div>
          </el-checkbox>

          <span class="checkbox-tip" v-if="childImgItem.amount>0">+{{ childImgItem.amount }}金币/单</span>
        </div>
      </el-checkbox-group>
    ...
    <div class="form-item">
      ...
      <span style="margin-right: 10px">
                          <el-checkbox v-model="form.taskAdditionalIncrement.baiTiao" :true-label="1" :false-label="2"
                                       style="color: #97A8BE">仅白条号可接任务接单</el-checkbox>
                    </span>
    ...
    export default {
        ...
        computed: {
            addpj: function () {
                ...
                //     tpList:[{type:3,content:'',norm:'',imgUrl1:'',imgUrl2:'',imgUrl3:'',imgUrl4:'',imgUrl5:''}],
