<template>
  <div class="form">
    ...
    <div class="form-item">
      <span class="form-required">*必填</span>
      <span class="form-label">设置打标关键词：</span>
      <el-input v-model="form.taskGoodsList[0].keyword" class="w400" size="small" />
      <div class="form-err form-err-change">(为保障打标效果请与搜索关键词一致)</div>
    </div>
