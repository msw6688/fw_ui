  ...
  <div class="form">
    ...
    <div v-for="item in addShop">
      ...
      <div class="form-item">
        ...
        <el-input-number
          v-model="form.taskGoodsList[item-1].num"
          :min="0"
          size="mini"
          style="width: 130px"
        />
    ...
    <div class="form-item">
      ...
      <el-input-number v-model="form.searchMinPrice" :min="0" size="mini" style="width: 130px" />
      <span style="color:#6666FF;width: 20px;font-size: 12px;text-align: center;">一</span>
      <el-input-number v-model="form.searchMaxPrice" :min="0" size="mini" style="width: 130px" />
      <span class="form-label" style="margin-left: 10px">元</span>
    </div>
    <div class="form-item">
      <span class="form-required">*必填</span>
      <span class="form-label">订单留言：</span>
      <el-input v-model="form.orderMessageBoard" size="mini" placeholder="最多50字！" style="width: 400px" />
    ...
    <div v-for="item in addpj" v-if="form.commentType===2" class="form-item">
      ...
      <el-input v-model="wzList[item-1].content" size="mini" style="width: 350px" />
    </div>
...
export default {
  ...
  methods: {
    ...
    onChangeProvince(a) {
      if (a.value !== '省') { this.form.searchLocation = a.value }
    },
    // 删除关键词
    delGuanjc(index) {
      ...
      if (val) {
        ...
        if (allData) {
          if (this.form.releaseDate && this.form.releaseDate === dataToDate) {
            ...
            const Arr = this.randomArr(allData, 1, allData / 2, len)
