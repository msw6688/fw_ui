      ...
      >
        ...
        <el-form-item class="login-center clearfix" prop="phone">
          ...
          <div class="login-center-input">
            <input type="text" class="validate" v-model="form.phone" placeholder="请输入您的手机号"
        ...
        <el-form-item class="login-center clearfix">
          ...
          <div class="login-center-input">
            <input type="text" v-model="captchaCode" class="validate" placeholder="请输入验证码"
        ...
        <el-form-item class="login-center clearfix" prop="vcode">
          ...
          <div class="login-center-input">
            <input type="text" v-model="form.vcode" placeholder="请输入短信验证码" onfocus="this.placeholder=''"
        ...
        <el-form-item class="login-center clearfix" prop="passwordConfirm">
          ...
          <div class="login-center-input">
            <input type="password" v-model="form.passwordConfirm" placeholder="请确认您的密码"
                   onfocus="this.placeholder=''" onblur="this.placeholder='请确认您的密码'">
        ...
        <el-form-item class="login-center clearfix" prop="qqNum">
          ...
          <div class="login-center-input">
            <input type="text" v-model="form.qqNum" placeholder="请输入您的QQ" onfocus="this.placeholder=''"
        ...
        <el-form-item class="login-center clearfix" prop="invite">
          ...
          <div class="login-center-input">
            <input v-model="form.invite" type="text" value="" class="validate" placeholder="邀请码"
                   onfocus="this.placeholder=''" onblur="this.placeholder='邀请码'">
            <div class="login-center-input-text">邀请码</div>
          </div>
        </el-form-item>

        <button type="submit" class="login-button" style="margin-left:100px;margin-top:0px;"
